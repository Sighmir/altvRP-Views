const data = {
  ...
  overlay: {
    blemishes: [...Array(24).keys(), 'None'].map(String),
    facialHair: [...Array(29).keys(), 'None'].map(String),
    eyebrows: [...Array(34).keys(), 'None'].map(String),
    ageing: [...Array(15).keys(), 'None'].map(String),
    makeup: [...Array(75).keys(), 'None'].map(String),
    blush: [...Array(7).keys(), 'None'].map(String),
    complexion: [...Array(12).keys(), 'None'].map(String),
    sunDamage: [...Array(11).keys(), 'None'].map(String),
    lipstick: [...Array(10).keys(), 'None'].map(String),
    molesFreckles: [...Array(18).keys(), 'None'].map(String),
    chestHair: [...Array(17).keys(), 'None'].map(String),
    bodyBlemishes: [...Array(12).keys(), 'None'].map(String),
  },
};
